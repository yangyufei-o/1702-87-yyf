...
<body style="margin:0px;">	
		...
		<div class="mui-content">
		    ...
		    <span style="font-size:16px;margin-right:80px;font-weight:bold;color:#0079fd;">当前位置:>员工信息</span>
			...
			<table id="dg" class="easyui-datagrid" title=" " style="width:1020px;height:600px"
				...
				<thead>
					<tr>
						...
						<th data-options="field:'p',width:100">角色编码</th>
					</tr>
				</thead>
				<tbody>
...
// 				$.messager.alert('Info', row.itemid+":"+row.productid+":"+row.attr1);
		...
		function zengjia(){
			$('#tt').tabs('add',{
				title: '基本信息',
				content: "<iframe frameborder='no' src='yuangong_add' style='width:1024px;height:600px;'></iframe>",
				closable: true
			});
		}
		function fanhui(){
